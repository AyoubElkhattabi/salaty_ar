...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800 border-left-primary p-3">Countries Prefixes</h1>
</div>
  <div>
    ...
    <table class="table">
        ...
        <tbody style="background: white;text-align:center">
          <tr>
            ...
            @foreach ($countriesPrefix as $prefix)
          ...
          <th scope="row"><a href="#">#{{$prefix->id}}</a></th>
            ...
            <a href="{{route('country-prefix.edit',$prefix->id)}}" class="btn btn-success btn-icon-split btn-sm">
            ...
            <span class="btn btn-danger btn-icon-split btn-sm">
                ...
                <form method="POST" action="{{route('country-prefix.destroy',$prefix->id)}}" class="d-inline">
                    @csrf
                    @method('DELETE')
